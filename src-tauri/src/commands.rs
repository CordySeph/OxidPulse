use crate::models::*;
use crate::diagnostics::{battery, storage, system_info, sensors, stress, crash_dump, scoring, report, benchmark, latency, memory_test, network, power};
...
pub fn get_power_throttling_diagnostics() -> PowerThrottlingMetrics {
    power::get_power_throttling_diagnostics()
}
